...
块链大小决定每个块存储的元素个数，元素不够的填充`\0`

![image-20231122100252037](./assets/image-20231122100252037.png)
...
![image-20231122101450194](./assets/image-20231122101450194.png)

2.为块链串填充内容

![image-20231122101535158](./assets/image-20231122101535158.png)

3.如果存在未填满的块

![image-20231122101610205](./assets/image-20231122101610205.png)
...
![image-20231122133219846](./assets/image-20231122133219846.png)

查找S中第pos(**5**)个元素所在的块(**2**)(注：称为目标块),并用指针pre指向它的前驱,p指向插入位置

![image-20231122134026654](./assets/image-20231122134026654.png)

将h到t范围的块插入到pos(**5**)所在的块(**2**)之前

![image-20231122140013442](./assets/image-20231122140013442.png)

如果插入到了某个块(**2**)的“中间”第5个位置，j的值变为了1

![image-20231122140042208](./assets/image-20231122140042208.png)

复制T中的元素到S中,j的值变为2,i的值变为1

![image-20231122141012277](./assets/image-20231122141012277.png)

如果T中最后一个块中包含`\0` 前移

![image-20231122143233537](./assets/image-20231122143233537.png)
