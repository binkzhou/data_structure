...
![image-20231213084946562](./assets/image-20231213084946562.png)
...
![image-20231213094150437](./assets/image-20231213094150437.png)
...
![image-20231213095537394](./assets/image-20231213095537394.png)
...
![image-20231213095856901](./assets/image-20231213095856901.png)
...
![image-20231213093603129](./assets/image-20231213093603129.png)
...
`FirstAdjVex(G,'V1')` `V1`的首个邻接点下标为`2`
...
顶点v相对于顶点w的下一个邻接顶点为`int k = NextAdjVex(G, v, w)`
...
1.获取需要删除结点的下标`k = LocateVex(*G, v);`

2.遍历每个结点的链表，超过k的顶点递减
