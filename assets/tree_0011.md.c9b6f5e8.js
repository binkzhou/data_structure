...
<span class="line"><span style="color:#6A737D;"> * 冪集元素类型也与线性表元素类型一致。</span></span>
<span class="line"><span style="color:#6A737D;"> */</span></span>
<span class="line"><span style="color:#D73A49;">typedef</span><span style="color:#24292E;"> LinkList List;</span></span></code></pre></div><h2 id="创建集合a" tabindex="-1">创建集合A <a class="header-anchor" href="#创建集合a" aria-label="Permalink to &quot;创建集合A&quot;">​</a></h2><p>集合A为一个链表</p><p><img src="`+o+`" alt="image-20231206111219257"></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-mj6VU" id="tab-weAFETr" checked="checked"><label for="tab-weAFETr">PwerSet.c</label><input type="radio" name="group-mj6VU" id="tab-ATBse-T"><label for="tab-ATBse-T">main.c</label><input type="radio" name="group-mj6VU" id="tab-fTwIHcM"><label for="tab-fTwIHcM">TestData_A.txt</label></div><div class="blocks"><div class="language-c vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/*━━━━━━━━━━━━━━━━━━━━━━ 仅限内部使用的函数 ━━━━━━━━━━━━━━━━━━━━━━*/</span></span>
