...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p><code>DFSTree</code> 通过深度遍历创建</p><p><img src="`+c+`" alt="image-20231214113656183"></p></div><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-1seWE" id="tab-VHJf6oy" checked="checked"><label for="tab-VHJf6oy">SpanningTree.c</label><input type="radio" name="group-1seWE" id="tab-uiMtShp"><label for="tab-uiMtShp">main.c</label><input type="radio" name="group-1seWE" id="tab-Q0edmKe"><label for="tab-Q0edmKe">TestData_UDG.txt</label></div><div class="blocks"><div class="language-c vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/*==================</span></span>
...
<span class="line"><span style="color:#24292e;">边的集合→【A，L】【A，B】【A，F】【A，C】【L，M】【L，J】【M，J】【M，B】【D，E】【G，K】【G，H】【G，I】【K，H】</span></span></code></pre></div></div></div>`,8),E=[r];function y(i,F,A,D,d,v){return n(),a("div",null,E)}const g=s(t,[["render",y]]);export{C as __pageData,g as default};
