...
<span class="line"><span style="color:#D73A49;">#endif</span></span></code></pre></div><h2 id="行编辑程序-1" tabindex="-1">行编辑程序 <a class="header-anchor" href="#行编辑程序-1" aria-label="Permalink to &quot;行编辑程序&quot;">​</a></h2><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-UERbe" id="tab-jUeiIZq" checked="checked"><label for="tab-jUeiIZq">LineEdit.c</label><input type="radio" name="group-UERbe" id="tab-YorKWan"><label for="tab-YorKWan">main.c</label></div><div class="blocks"><div class="language-c vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/*</span></span>
